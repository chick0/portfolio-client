<script>
    ...
    let buttons = [];
    let buttonColors = [
        "is-white", "is-light", "is-dark", "is-black", "is-ghost",
    ...
    if(typeof url !== "string"){
        ...
        fetch(buttonUpdate(params.uuid)).then((resp) => resp.json()).then((json) => {
            ...
            <div class="box">
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input class="input" type="text" id="button-text-{button.uuid}" bind:value={button.text}>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input class="input" type="url" id="button-link-{button.uuid}" bind:value={button.url}>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            on:click={() => {
                                ...
                                if(button.uuid == "undefined"){
                                    ...
                                    fetch(buttonUpdate(button.uuid), {
                                        ...
                                        buttons[
                                            buttons.findIndex((e) => e.uuid == json.uuid)
                                        ] = json;
                                    });
                                }
                            }}
